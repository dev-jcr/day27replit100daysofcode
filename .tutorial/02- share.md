...
### Add the hashtag `#replit100daysofcode` *and* `#characterGenerator` so people in the community can find it when they search. (You could also add `#python` or any other tags you want).
